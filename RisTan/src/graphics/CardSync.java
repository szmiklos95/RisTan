...
/**
 * Synchronisation class that contains all the necessary variables for the
 * JPanel cards to interact between each other. Package level visible.
 * 
 * @author Miklós
 *
 */
class CardSync {
	...
	/**
	 * JPanel that functions as a card. The game window that contains the game
	 * board.
	 */
	...
	/**
	 * Sets the game state only locally in this class. The game state cannot be
	 * modified from here.
	 * 
	 * @param gameState
	 *            the new game state
