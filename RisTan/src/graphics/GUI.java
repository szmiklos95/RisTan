...
public class GUI extends JFrame {
	...
	private JPanel card_JoinWindow;
	...
	public void addComponentsToPane(Container pane) {
		...
		cards.add(card_JoinWindow, Config.GUI.CardIDs.joinWindow);
	...
	/**
	 * The join window where the clients can enter the address of the server
	 * @return
	 */
	private JPanel createCard_JoinWindow() {
		JPanel card = new JPanel();
		...
		join.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				CardLayout cl = (CardLayout) (cards.getLayout());
				cl.show(cards, e.getActionCommand());
				System.out.print("Player " + settings.getPlayerName() + " joining the game.\n");
			}
		});
		card.add(join);
